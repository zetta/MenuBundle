...
class BuilderAliasProvider implements MenuProviderInterface
{
    ...
    public function __construct(KernelInterface $kernel, ContainerInterface $container, FactoryInterface $menuFactory, SecurityInterface $security)
    {
        $this->kernel = $kernel;
    ...
    public function get($name, array $options = array())
    {
        ...
        $provider = new SecureProvider($reader, $this->security);
        $menu = $provider->filter( $builder, array($this->menuFactory, $options) );
